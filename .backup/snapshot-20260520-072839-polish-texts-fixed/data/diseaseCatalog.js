export const DISEASE_SYMPTOMS = [
  { id: 'white_spots', label: "Białe kropki na ciele lub płetwach" },
  { id: 'gold_dust', label: "Złotawy pył na ciele" },
  { id: 'cotton_growth', label: "Biały nalot (jak wata)" },
  { id: 'frayed_fins', label: "Postrzępione płetwy" },
  { id: 'clamped_fins', label: "Sklejone płetwy" },
  { id: 'flashing', label: "Ocieranie się o podłoże/dekoracje" },
  { id: 'rapid_breathing', label: "Przyspieszony oddech / łapie powietrze" },
  { id: 'red_gills', label: 'Zaczerwienione skrzela' },
  { id: 'loss_appetite', label: 'Brak apetytu' },
  { id: 'lethargy', label: "Ospałość / apatia" },
  { id: 'bloating', label: "Wzdęcie brzucha" },
  { id: 'skinny_body', label: "Chudnięcie mimo karmienia" },
  { id: 'stringy_feces', label: "Białe, ciągnące odchody" },
  { id: 'ulcers', label: 'Rany / owrzodzenia' },
  { id: 'cloudy_eyes', label: 'Mleczne oczy' },
  { id: 'color_loss', label: "Wyraźna utrata kolorów" },
  { id: 'sudden_deaths', label: "Nagły pad kilku ryb" },
];
...
const RAW_DISEASE_CATALOG = [
  {
    ...
    severity: 'high',
    summary:
      "Pasozyt powodujacy białe kropki i silny swiad skory. Rozwija się szybko, szczególnie przy stresie.",
    symptoms: [
      'white_spots',
      'flashing',
      'clamped_fins',
    ...
    treatment: [
      "Odizoluj najslabsze osobniki, jesli to możliwe.",
      'Przy ospie podnies temperature stopniowo o 1 C/dobe (zwykle do 28-30 C), tylko jesli obsada to toleruje.',
      "Zweryfikuj napowietrzanie i stabilność temperatury.",
      "Rozważ leczenie preparatem przeciw ospie: Tropical CMF, Sera Costapur lub eSHa Exit (zawsze zgodnie z etykieta).",
      "Ogranicz oświetlenie na czas leczenia i unikaj naglych skoków temperatury.",
      "Kontynuuj kuracje pelny zalecany czas, nawet po poprawie objawów.",
    ],
    caution:
  ...
  },
  {
    ...
    treatment: [
      "Ogranicz oświetlenie na czas leczenia.",
      "Utrzymuj stabilna temperature (najczęściej 27-28 C, jesli gatunki toleruja) i mocne napowietrzanie.",
      'Zweryfikuj silne napowietrzanie.',
      "Rozważ preparat na oodinioze: Sera Oodinopur, eSHa Exit lub JBL Punktol Plus (zgodnie z etykieta).",
    ],
    caution:
  ...
  },
  {
    ...
    severity: 'medium',
    summary:
      "Najczęściej infekcja bakteryjna wtornie do stresu lub słabiej higieny. Objawia się niszczeniem brzegow płetw.",
    symptoms: [
      'frayed_fins',
      'clamped_fins',
      'loss_appetite',
    ...
    treatment: [
      "Popraw jakość wody i ogranicz stres obsady.",
      "Utrzymuj stabilna temperature (zwykle 24-26 C) i regularny czas świecenia lampy bez naglych zmian.",
      'Usuń potencjalne przyczyny urazow (ostre dekoracje, agresje).',
      "W ciezszych przypadkach rozważ leczenie antybakteryjne: Sera Baktopur, Sera Baktopur Direct lub eSHa 2000 (zgodnie z etykieta).",
    ],
    caution:
      "Bez poprawy warunków w akwarium objawy często wracaja mimo leczenia preparatami.",
  },
  {
    id: 'fungal',
    ...
    severity: 'medium',
    summary:
      "Biały, watowaty nalot zwykle pojawia się na uszkodzonej tkance i oslabionych rybach.",
    symptoms: [
      'cotton_growth',
      'lethargy',
      'loss_appetite',
    ...
    treatment: [
      "Oddziel chore ryby, jesli to możliwe.",
      "Utrzymuj stabilna temperature i umiarkowane oświetlenie, bez gwaltownych zmian.",
      "Usuń martwe tkanki i źródła urazow z akwarium.",
      "Rozważ preparat przeciwgrzybiczy: Sera Mycopur, JBL Fungol lub eSHa 2000 (zgodnie z etykieta).",
    ],
    caution:
      "Grzybica bywa wtornym skutkiem innego problemu. Rownolegle sprawdź przyczyne pierwotna.",
  },
  {
    id: 'gill_flukes',
    ...
    treatment: [
      ...
      "Zwiększ napowietrzanie i monitoruj zachowanie ryb.",
      "Rozważ preparat na przywry: Sera Tremazol, JBL Gyrodol Plus 250 lub eSHa gdex (zgodnie z etykieta).",
      'Po kuracji odmul podłoże i wykonaj bezpieczna podmiane wody.',
    ],
    caution:
      "Przy ciężkich dusznosciach dzialaj szybko. Niedotlenienie może byc grozniejsze niz sama choroba.",
  },
  {
    id: 'hexamita',
    name: 'Hexamitoza',
    ...
    severity: 'medium',
    summary:
      "Często zwiazana z oslabieniem odpornosci, objawia się chudnieciem i bialymi odchodami.",
    symptoms: [
      'stringy_feces',
      'loss_appetite',
      'lethargy',
    ...
    treatment: [
      "Zapewnij najwyzsza jakość wody i spokojne warunki.",
      "Utrzymuj stabilna temperature i stały cykl dnia/nocy (bez wydluzania oświetlenia).",
      "Rozważ preparat celowany na wiciowce: Sera Flagellol lub kuracje z metronidazolem po konsultacji specjalisty.",
      'Ogranicz stres i rywalizacje przy karmieniu.',
    ],
    caution:
      "Objawy są nieswoiste. Potwierdzenie przyczyny bywa trudne bez konsultacji specjalisty.",
  },
  {
    id: 'dropsy',
    ...
    severity: 'high',
    summary:
      "Silne wzdęcie i pogorszenie kondycji. To często objaw ciężkiego problemu, a nie jedna konkretna choroba.",
    symptoms: [
      'bloating',
      'loss_appetite',
      'lethargy',
    ...
    treatment: [
      ...
      "Zapewnij stabilna temperature i słabiej intensywne oświetlenie, by ograniczyc stres.",
      'Stabilizuj parametry i zapewnij mocne napowietrzanie.',
      "Leczenie wspierajace: eSHa 2000 lub Sera Baktopur; przy ciężkich przypadkach konsultacja weterynaryjna przed silniejszymi lekami.",
    ],
    caution:
  ...
  },
  {
    ...
    severity: 'high',
    summary:
      "Możliwe zaczerwienienia, owrzodzenia, apatia i szybkie pogorszenie stanu.",
    symptoms: [
      'ulcers',
      'red_gills',
      'lethargy',
    ...
    treatment: [
      ...
      "Utrzymuj stabilna temperature (bez skoków) i ogranicz oświetlenie na czas leczenia.",
      "Sprawdź natychmiast parametry i wykonaj bezpieczna podmiane wody.",
      "Rozważ leczenie antybakteryjne: Sera Baktopur Direct, JBL Furanol lub eSHa 2000 (zgodnie z etykieta i po konsultacji specjalisty).",
    ],
    caution:
  ...
  },
  {
    ...
    severity: 'high',
    summary:
      "Bakteryjna choroba przebiegajaca szybko, często z nalotem wokol pyska i uszkodzeniami skory.",
    ...
    treatment: [
      ...
      "Rozważ leczenie antybakteryjne zgodnie z etykieta preparatu.",
      'Ogranicz stres i obserwuj postep codziennie.',
    ],
    caution:
      "Choroba może postepowac bardzo szybko. Reaguj od razu i nie lacz lekow bez konsultacji.",
  },
  {
    id: 'popeye',
    ...
    severity: 'medium',
    summary:
      "Objaw zapalny lub urazowy oka, często zwiazany z jakoscia wody albo infekcja wtorną.",
    symptoms: ['cloudy_eyes', 'lethargy', 'loss_appetite', 'color_loss'],
    treatment: [
      "Sprawdź parametry i natychmiast popraw jakość wody.",
      "Usuń czynniki urazowe i agresywne wspolgatunki.",
      'W razie podejrzenia infekcji rozważ leczenie antybakteryjne.',
      "Obserwuj, czy obrzęk się cofa po stabilizacji warunków.",
    ],
    caution:
  ...
  },
  {
    ...
    caution:
      "Przewlekle objawy mogą maskowac infekcje pasozytnicze lub problemy pecherza plawnego.",
  },
  {
    id: 'swim_bladder_disorder',
    name: 'Problemy z pecherzem plawnym',
    imageSourceLabel: '',
    suggestedRemedy: "Korekta diety i warunków",
    severity: 'medium',
    summary:
    ...
    treatment: [
      ...
      "Wprowadz lekka dietę i kontroluj ilość karmy.",
      "Sprawdź parametry, szczególnie azotowe i temperature.",
      "Przy braku poprawy rozważ konsultacje specjalistyczna.",
    ],
    caution:
  ...
  },
  {
    ...
    treatment: [
      ...
      "Sprawdź wydajnosc filtra biologicznego.",
      "Rozważ czasowe wsparcie preparatem neutralizujacym amoniak.",
    ],
    caution:
      "To stan nagły. Priorytetem jest tlen i szybkie zbicie toksyn.",
  },
  {
    ...
    treatment: [
      "Wykonaj natychmiastowa podmiane i zwiększ napowietrzanie.",
      "Sprawdź cykl azotowy i obciazenie biologiczne.",
      'Ogranicz karmienie do czasu spadku NO2.',
      'Monitoruj NO2 codziennie do pelnej stabilizacji.',
    ],
    caution:
      "Nawet umiarkowane NO2 może byc grozne. Reaguj natychmiast.",
  },
  {
    id: 'hypoxia',
    ...
    severity: 'high',
    summary:
      "Niedobor tlenu objawia się lapaniem powietrza i ospaloscia calej obsady.",
    symptoms: ['rapid_breathing', 'lethargy', 'color_loss', 'sudden_deaths'],
    treatment: [
      "Natychmiast zwiększ ruch tafli i napowietrzanie.",
      'Skontroluj temperature, bo ciepla woda trzyma mniej tlenu.',
      'Usuń nadmiar osadu i materii organicznej.',
      "Sprawdź droznosc filtra i cyrkulacje.",
    ],
    caution:
  ...
  },
  {
    ...
    treatment: [
      "Przywroc temperature stopniowo, bez skoków.",
  ...
  },
  {
    ...
    caution:
      "Najgrozniejsze są gwaltowne wahania. Stabilnosc wazniejsza niz idealna wartosc.",
  },
  {
    ...
    treatment: [
      "Usuń ostre elementy i popraw bezpieczenstwo aranżacji.",
      "Popraw jakość wody, by wspierac gojenie.",
      'Ogranicz stres i agresje w obsadzie.',
      "W razie nadkazenia rozważ leczenie wspierajace.",
    ],
    caution:
  ...
  },
  {
    ...
    treatment: [
      "Ogranicz światło i ruch wokol akwarium.",
      "Zapewnij powolna aklimatyzacje temperatury i parametrów.",
      'Nie przekarmiaj w pierwszej dobie po wpuszczeniu.',
      'Obserwuj, czy objawy nie przechodza w infekcje.',
    ],
    caution:
      "Nadmierny stres po transporcie zwiększa podatnosc na pasozyty i infekcje.",
  },
  {
    id: 'aggression_fin_nipping',
    name: "Agresja i obgryzanie płetw",
    imageSourceLabel: '',
    suggestedRemedy: "Korekta obsady i kryjówek",
    severity: 'medium',
    summary:
      "Uszkodzenia płetw i stres behawioralny wynikajacy z niedopasowanej obsady.",
    symptoms: ['frayed_fins', 'clamped_fins', 'lethargy', 'loss_appetite', 'color_loss'],
    treatment: [
      'Rozdziel konfliktowe gatunki lub osobniki.',
      "Zwiększ liczbe kryjówek i bariery wzrokowe.",
      "Sprawdź proporcje plci i liczebnosc stadna.",
      "Usuń urazogenne elementy w akwarium.",
    ],
    caution:
      "Przewlekla agresja może prowadzic do wtornych infekcji i padniec.",
  },
  {
    id: 'skin_flukes',
    name: 'Przywry skorne',
    ...
    treatment: [
      "Zwiększ napowietrzanie i ogranicz stres.",
  ...
  },
  {
    ...
    severity: 'high',
    summary:
      "Postepujaca utrata masy ciala mimo karmienia, często zwiazana z pasozytami lub przewleklym stresem.",
    symptoms: ['skinny_body', 'loss_appetite', 'stringy_feces', 'lethargy', 'color_loss'],
    treatment: [
      'Odizoluj oslabione osobniki i popraw jakość wody.',
      "Zweryfikuj pasozyty wewnetrzne i jakość pokarmu.",
  ...
  },
  {
    ...
    severity: 'high',
    summary:
      "Ubytki tkanek w okolicy glowy, często wspolistniejace z oslabieniem i problemami jelitowymi.",
    symptoms: ['ulcers', 'skinny_body', 'stringy_feces', 'loss_appetite', 'lethargy'],
    treatment: [
      'Popraw warunki i ogranicz stres w akwarium.',
      "Rozważ leczenie na wiciowce zgodnie z zaleceniami.",
      'Utrzymuj wysoka higienę i regularne podmiany.',
      "Monitoruj, czy zmiany skorne nie pogłębiaja się.",
    ],
    caution:
      "Często towarzyszy innym problemom. Leczenie musi obejmowac przyczyne pierwotna.",
  },
  {
    ...
    caution:
      "Wysokie NO3 rzadko daje nagły kryzys, ale długofalowo silnie szkodzi obsadzie.",
  },
  {
    id: 'osmotic_shock',
    ...
    treatment: [
      "Ustabilizuj GH/KH/TDS i unikaj dalszych skoków.",
      "Wykonuj tylko ostrozne korekty parametrów.",
      'Zapewnij mocne natlenienie i spokoj.',
      'Przy kolejnych podmianach trzymaj stale parametry.',
    ],
    caution:
      "Najwazniejsza jest stabilność. Nie koryguj agresywnie kilku parametrów naraz.",
  },
  {
    id: 'ammonia_burn',
    ...
    treatment: [
      "Natychmiast wykonaj podmiane i zwiększ napowietrzanie.",
      'Ogranicz karmienie i obciazenie biologiczne.',
      "Sprawdź filtracje biologiczna i dojrzalosc zbiornika.",
  ...
  },
  {
    ...
    imageSourceLabel: '',
    suggestedRemedy: "Usuniecie toksyny + duża podmiana",
    severity: 'high',
    summary:
    ...
    treatment: [
      "Natychmiast usuń potencjalne źródło toksyny.",
      "Wykonaj duża, bezpieczna podmiane i zastosuj silna aeracje.",
      'Dodaj swiezy filtr chemiczny (np. wegiel aktywny), jesli wskazane.',
      'Obserwuj ryby przez 48h pod katem nawrotu dusznosci.',
    ],
    caution:
      "Przy ostrym zatruciu liczy się czas. Dzialaj awaryjnie i ostroznie.",
  },
  {
    id: 'fight_wounds',
    ...
    symptoms: ['ulcers', 'frayed_fins', 'clamped_fins', 'lethargy'],
    treatment: [
      "Rozdziel walczace osobniki i popraw strukturę kryjówek.",
      "Utrzymuj wysoka jakość wody dla szybszego gojenia.",
      "Ogranicz dodatkowy stres (światło, manipulacje).",
  ...
  },
  {
    ...
    symptoms: ['clamped_fins', 'lethargy', 'loss_appetite', 'color_loss'],
    treatment: [
      "Utrzymaj spokoj i ogranicz światło na starcie.",
      'Zadbaj o kryjowki i bezpieczne strefy.',
      'Podawaj male porcje pokarmu po ustabilizowaniu zachowania.',
      "Obserwuj, czy nie pojawia się objawy wtornych chorob.",
    ],
    caution:
      "Przedluzajacy się stres po wpuszczeniu może byc sygnalem niezgodnej obsady.",
  },
  {
    id: 'cichlid_bloat',
    ...
    severity: 'high',
    summary:
      "Ciężkie zaburzenie trawienne i zapalne spotykane u pielegnic, często nasilane stresem i dieta.",
    symptoms: ['bloating', 'loss_appetite', 'stringy_feces', 'lethargy', 'color_loss'],
    treatment: [
      'Natychmiast odizoluj chore osobniki.',
      "Wstrzymaj karmienie na krótko, potem wprowadz lekkostrawna diete.",
      "Sprawdź jakość wody i ogranicz agresje w zbiorniku.",
      "Rozważ leczenie celowane po konsultacji specjalisty.",
    ],
    caution:
      "Przebieg może byc gwaltowny. Wczesna reakcja mocno zwiększa szanse poprawy.",
  },
  {
    ...
    severity: 'high',
    summary:
      "Kontakt z nieuzdatniona woda wodociagowa może uszkadzac skrzela i blony sluzowe.",
    ...
    treatment: [
      ...
      "Monitoruj ryby pod katem dalszych objawów uszkodzenia skrzeli.",
    ],
    caution:
  ...
  },
  {
    ...
    treatment: [
      ...
      "Sprawdź drop checker, pH i KH w cyklu dobowym.",
      'Obserwuj ryby przez kolejne 24h po korekcie.',
    ],
    caution:
      "Nagły wzrost CO2 bywa smiertelny. Utrzymuj stabilne, przewidywalne dozowanie.",
  },
];
