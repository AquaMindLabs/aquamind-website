const RAW_PLANT_CATALOG_STARTER = [
  {
    ...
    tempMax: 28,
    minLiters: 20,
    notes: "Epifit pierwszego wyboru dla początkujących.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 30,
    notes: "Łatwa roślina na korzenie i kamienie, nie zakopuj kłącza.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 40,
    notes: "Lubi stabilne warunki, może chwilowo gubic liście po zmianie.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 60,
    notes: "Łatwa roślina tla, dobrze znosi start akwarium.",
  },
  {
  ...
  },
  {
    ...
    tempMax: 28,
    minLiters: 20,
    notes: "Bardzo łatwa roślina szybkorosnaca, może plywac lub byc dociazona.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 30,
    notes: "Szybko rosnaca łodygowa roślina dobra dla początkujących.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 40,
    notes: "Łatwa łodygowa roślina z czerwienszymi akcentami przy lepszym świetle.",
  },
  {
  ...
  },
  {
    ...
    tempMax: 28,
    minLiters: 40,
    notes: "Popularna łodygowa roślina szybkorosnaca.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 30,
    notes: "Wytrzymala roślina łodygowa o grubych liściach.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 40,
    notes: "Delikatniejsza łodygowa roślina tla, lubi czysta wodę.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 50,
    notes: "Efektowna łodygowa roślina tla, lepiej rosnie przy dobrym świetle.",
  },
  {
  ...
  },
  {
    ...
    tempMax: 28,
    minLiters: 25,
    notes: "Łatwiejsza roślina na niski pierwszy plan.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 30,
    notes: "Łatwa roślina na pierwszy plan lub srodek zbiornika.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 20,
    notes: "Bardzo łatwy mech do korzeni, kamieni i kryjówek.",
  },
  {
  ...
  },
  {
    ...
    tempMax: 28,
    minLiters: 20,
    notes: "Może plywac lub byc mocowana do siatki jako zielony akcent.",
  },
  {
    commonName: 'Pistia',
  ...
  },
  {
    ...
    tempMax: 28,
    minLiters: 20,
    notes: "Popularna roślina plywajaca z dłuższymi korzeniami.",
  },
  {
    ...
    tempMax: 28,
    minLiters: 20,
    notes: "Drobna roślina plywajaca, szybko się mnozy.",
  },
];
