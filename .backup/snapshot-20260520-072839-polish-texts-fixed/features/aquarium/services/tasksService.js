...
export function generateAdaptiveTaskSchedule(tank, context = {}) {
  ...
  addTask({
    ...
    title: 'Podmiana wody',
    details: highToxins
      ? "Parametry toksyn są niebezpieczne - wykonaj podmianę natychmiast."
  ...
  addTask({
    key: 'fertilization',
    title: "Nawozenie roślin",
    details:
      "Dostosuj dawki nawożenia do kondycji roślin, światła i trendow parametrów. Zmieniaj stopniowo.",
  ...
  addTask({
    key: 'pruning',
    title: "Przycinka roślin",
    details:
      "Usuwaj nadmierny przyrost i słabe liście, zeby poprawic cyrkulacje i ograniczyć ryzyko glonów.",
  ...
  addTask({
    ...
    details: tempOutOfRange
      ...
      : "Sprawdzaj stabilność temperatury i działanie grzałki.",
  ...
  return {
    ...
    summary:
      dueToday.length > 0
        ...
        : "Brak zadan na dzis, kolejne zadania są zaplanowane automatycznie.",
  };
}
...
export function buildTodayActionPlanService(tank, context = {}) {
  ...
  if (overallStockingStatus === 'incompatible') {
    addCandidate(
      ...
      "Wysokie ryzyko konfliktów lub niezgodnosci warunków.",
      'stocking',
      90
    );
    ...
    addCandidate(
      ...
      "Zredukowac ryzyko przez dopasowanie liczebnosci i gatunków.",
      'stocking',
      64
    );
  }
  ...
  if (activeIssueCount > 0) {
    addCandidate(
      ...
      "Sprawdź harmonogram leczenia lub plan ograniczania glonów.",
      'issues',
      62
    );
  }
  ...
  if (Boolean(onboardingPlan?.isActive) && Array.isArray(onboardingPlan?.rows)) {
    ...
    if (hasOnboardingWarnings) {
      addCandidate(
        ...
        "W planie startowym są ostrzezenia do wykonania dzis.",
        'onboarding',
        74
      );
    }
  ...
  if (!latestMeasurementMs) {
    ...
    if (daysSinceMeasurement >= 7) {
      addCandidate(
        ...
        `Pomiary są nieaktualne (${daysSinceMeasurement} dni)`,
  ...
  if (Number(healthAssessment?.score) > 0 && Number(healthAssessment?.score) < 50) {
    addCandidate(
      ...
      "Skup się na trzech największych karach i wykonaj korekty dzis.",
      'health',
      88
    );
  }
...
const ONBOARDING_DELAY_MESSAGES = {
  ...
  unstableTemperature:
    "Temperatura nie jest jeszcze stabilna. Przed dodaniem obsady upewnij się, ze akwarium utrzymuje docelowa temperature przez minimum 24-48 godzin.",
  phSwing:
    "pH zmienilo się zauważalnie względem poprzedniego pomiaru. Przed kolejnym krokiem warto potwierdzic stabilność parametrów.",
  highNo3:
    "NO3 jest podwyzszone. Rozważ podmianę wody i ponowny pomiar. Samo NO3 nie zawsze blokuje kolejny krok, ale przy wysokich wartościach zwiększa ryzyko problemów.",
};
  ...
  new_from_scratch: [
    {
      ...
      description:
        "Akwarium zostało zalozone. Najważniejsze jest uruchomienie filtracji i stabilnych warunków.",
    ...
    },
    {
      ...
      description:
        "W akwarium może zaczynac pojawiac się NO2. To normalny etap dojrzewania biologicznego.",
      startType: 'new_from_scratch',
      earliestDay: 3,
      recommendedDay: 3,
      delayDays: 2,
    ...
    },
    {
      ...
      description:
        "Jesli NO2 utrzymuje się na 0 i temperatura jest stabilna, mozna rozwazyc mala część obsady.",
      startType: 'new_from_scratch',
      earliestDay: 21,
      recommendedDay: 21,
      delayDays: 3,
    ...
    },
    {
      ...
      description:
        "Po dodaniu ryb filtr biologiczny dopasowuje się do większego obciążenia.",
      startType: 'new_from_scratch',
      earliestDay: 28,
      recommendedDay: 28,
      delayDays: 3,
    ...
    },
    {
      ...
      description:
        "Jesli parametry pozostały stabilne, mozna ostroznie dodac kolejna część obsady.",
      startType: 'new_from_scratch',
      earliestDay: 35,
      recommendedDay: 35,
      delayDays: 3,
      actions: [
        "Dodaj kolejna mala część obsady.",
  ...
  restart: [
    {
      ...
      description:
        "Po restarcie zbiornik może reagowac niestabilnie, nawet gdy część biologii została zachowana.",
      startType: 'restart',
      earliestDay: 1,
      recommendedDay: 1,
      delayDays: 1,
    ...
    },
    {
      ...
      description:
        "To moment, gdy po restarcie najczęściej ujawniaja się problemy z biologia.",
      startType: 'restart',
      earliestDay: 3,
      recommendedDay: 3,
      delayDays: 2,
    ...
    },
    {
      ...
      description:
        "Jesli NO2 utrzymuje się na 0 i temperatura jest stabilna, restart przebiega poprawnie.",
      startType: 'restart',
      earliestDay: 7,
      recommendedDay: 7,
      delayDays: 3,
...
const ONBOARDING_GUIDE_BY_START_TYPE = {
  ...
  mature_media_start: {
    ...
    checklistStart: [
      ...
      "Potwierdź stabilność po kazdym zwiększeniu obciążenia.",
    ],
    firstMeasurements: [
      'Dzień 1: NO2, NO3, temperatura, pH/KH.',
      'Dzień 3: NO2 + NO3.',
