...
function buildNo2EmergencyCase(no2Value) {
  ...
  return {
    ...
    summary:
      "Azotyny ograniczaja transport tlenu i mogą szybko pogorszyc stan ryb.",
    steps: [
      ...
      "Sprawdź droznosc filtra i przepływ, ale nie płucz calego medium naraz.",
...
function buildNh3Nh4EmergencyCase(nh3nh4Value) {
  ...
  return {
    ...
    summary:
      "Amoniak i jon amonowy mogą byc silnie toksyczne, szczególnie przy wyzszym pH i temperaturze.",
    steps: [
      "Wykonaj podmianę 40-60% wody i uzdatnij nowa wodę.",
      'Zwiksz napowietrzanie oraz ruch tafli.',
      'Wstrzymaj karmienie na 24h, potem dawkuj bardzo oszczednie.',
      "Sprawdź, czy filtr pracuje stabilnie i czy nie doszlo do przerwy biologii.",
...
function buildGaspingEmergencyCase() {
  return {
    ...
    steps: [
      ...
      "Sprawdź temperature i działanie filtra.",
...
function buildFilterStoppedEmergencyCase(filterStatusLabel) {
  return {
    ...
    steps: [
      ...
      "Sprawdź NO2 i NH3/NH4 po przywróceniu obiegu.",
...
function buildHighTemperatureEmergencyCase(temperatureValue, thresholdValue) {
  return {
    ...
    summary:
      "Przegrzanie zmniejsza ilość tlenu w wodzie i może nasilac stres oraz toksycznosc.",
    steps: [
      ...
      "Sprawdź, czy grzałka nie jest zablokowana w pozycji grzania.",
