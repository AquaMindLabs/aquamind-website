...
type ActionCalendarPanelProps = {
  ...
  labels: {
    ...
    title: string;
    planSummary: string;
    waterChangeInterval: string;
    gravelVacuumInterval: string;
    filterServiceInterval: string;
    postWaterChangeTest: string;
    empty: string;
    overdue: string;
    done: string;
    skip: string;
    postponeOneDay: string;
  };
      ...
      {!hasTaskReminderAccess ? (
        ...
        <View style={{ marginTop: 8 }}>
          <Text style={{ color: theme.textSecondary, fontSize: 12 }}>
            {formatLabel(labels.planSummary, { days: waterActionCalendar.windowDays })}
          </Text>
          ...
          <View
            ...
            <View
              ...
              <Text style={{ color: theme.textSecondary, fontSize: 11 }}>
                {formatLabel(labels.waterChangeInterval, {
                  days: waterActionCalendar.waterChangeIntervalDays,
                })}
              </Text>
            </View>
            <View
              ...
              <Text style={{ color: theme.textSecondary, fontSize: 11 }}>
                {formatLabel(labels.gravelVacuumInterval, {
                  days: waterActionCalendar.gravelVacuumIntervalDays,
                })}
              </Text>
            </View>
            <View
              ...
              <Text style={{ color: theme.textSecondary, fontSize: 11 }}>
                {formatLabel(labels.filterServiceInterval, {
                  days: waterActionCalendar.filterServiceIntervalDays,
                })}
              </Text>
            </View>
          </View>
