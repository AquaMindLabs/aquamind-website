...
function buildProductTierMapFromEnv(env = process.env) {
  ...
  const entries = [
    ...
    {
      productId: env.EXPO_PUBLIC_SUBSCRIPTION_PLUS_ANDROID_PRODUCT_ID,
      tier: 'premium',
    },
    {
    ...
    {
      productId: 'aquamind_plus_monthly:monthly',
      tier: 'premium',
    },
    {
      productId: 'aquamind_plus_monthly',
      tier: 'premium',
    },
    {
    ...
    {
      productId: env.EXPO_PUBLIC_SUBSCRIPTION_AI_PRO_ANDROID_PRODUCT_ID,
      tier: 'pro',
    },
    {
    ...
    {
      productId: 'aquamind_ai_pro_monthly:monthly',
      tier: 'pro',
    },
    {
      productId: 'aquamind_ai_pro_monthly',
      tier: 'pro',
    },
  ];
...
function normalizeExistingSubscription(value) {
  ...
  return {
    ...
    productId: String(current.productId ?? '').trim() || null,
...
function mapRevenueCatEventToSubscriptionState({
  ...
  return {
    ...
    nextSubscription: {
      ...
      productId: event.productId ?? previous.productId ?? null,
      startedAt,
      expiresAt,
      renewsAt,
